        ...
        ZStack {
            ...
            VStack(alignment: .leading) {
                ...
                Text(cloth.name)
                    ...
                    .padding([.horizontal], 5)
                HStack {
                    Text("RM\(cloth.price - (cloth.price * cloth.discount)/100)")
                        .font(.custom(Constants.AppFont.semiBoldFont, size: 13))
...
struct ItemRow_Previews: PreviewProvider {
    static var previews: some View {
        ItemRow(cloth: Cloth(name: "Sauvage Elixer", description: "Elixir - Spicy, Fresh and Woody Notes", imageURL: "redDress", price: 619, company: "Dior", rating: 4, type: "sale", isFavorite: false, color: "Red", size: "S", discount: 40))
    }
}
