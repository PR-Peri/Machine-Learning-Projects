                    ...
                    VStack {
                        ...
                        VStack {
                            HStack {
                                ...
                                Spacer()
                                Text("RM\(self.arrCloth.reduce(0, { $0 + $1.price }))")
                            ...
                            HStack {
                                Text("Discount")
                                    ...
                                    .foregroundColor(Constants.AppColor.secondaryBlack)
                                Spacer()
                                Text("- RM\(self.arrCloth.reduce(0, { $0 + ($1.price * $1.discount)/100}))")
                                    .font(.custom(Constants.AppFont.boldFont, size: 13))
                            ...
                            HStack {
                                Text("Total Amount")
                                    ...
                                    .foregroundColor(Constants.AppColor.secondaryBlack)
                                Spacer()
                                Text("RM\(self.arrCloth.reduce(0, { $0 + ($1.price - ($1.price * $1.discount)/100)}))")
                                    .font(.custom(Constants.AppFont.boldFont, size: 16))
                                    .foregroundColor(Constants.AppColor.secondaryBlack)
                            }
                            .padding(.horizontal, 15)
